...
def load_models(model_paths, macroX, macro_txtshape):
    ...
    for key, paths in model_paths.items():
        ...
        for path in paths:
            ...
            model = HybridAttentionMLP(input_size, text_shape, dropout=0.8)
...
def main():
    ...
    models = {
        "w2v": ["/fhome/amir/TFG/models/hybridation_neurons/MLP2_HUMAN_w2v_1_att.pth",
                "/fhome/amir/TFG/models/hybridation_neurons/MLP2_HUMAN_w2v_2_att.pth"],
        "BERT": ["/fhome/amir/TFG/models/hybridation_neurons/MLP2_HUMAN_BERT_1_att.pth",
                "/fhome/amir/TFG/models/hybridation_neurons/MLP2_HUMAN_BERT_2_att.pth"],
        "AE1BERT": ["/fhome/amir/TFG/models/hybridation_neurons/MLP2_HUMAN_AE1BERT_1_att.pth",
                    "/fhome/amir/TFG/models/hybridation_neurons/MLP2_HUMAN_AE1BERT_2_att.pth"],
            }
